                ...
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent((() => {
                    const tweets = [
                      ...
                      `Just swept some Pepe Gods V2 and now collecting airdrops 🤑 ${parseFloat(airdropSuccess.tokenAmount).toLocaleString(undefined, { maximumFractionDigits: 0 })} $${airdropSuccess.tokenSymbol} claimed from @pepegodssol — staking pays! magiceden.io/marketplace/pepe_gods_v2`,
